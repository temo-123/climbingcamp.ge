...
<head>
    <meta charset="utf-8">
    <title>{{ $head_image["title"] }} - {{ $site_info->where('key_word', 'site_title')->first()->text }}</title>

    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="{{ $head_image['title'] }} - {{ $site_info->where('key_word', 'site_title')->first()->text }}" name="keywords">
    ...
    <meta name="twitter:title" content="{{ $head_image['title'] }} - {{ $site_info->where('key_word', 'site_title')->first()->text }}">
    ...
    <meta property="og:title" content="{{ $head_image['title'] }} - {{ $site_info->where('key_word', 'site_title')->first()->text }}" />
